...
"[project]/apps/web/src/components/ui/auth/signUpForm.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/apps/web/src/components/ui/auth/signUpForm.tsx'

Expected ',', got 'string literal (An unexpected error occurred. Please try again., 'An unexpected error occurred. Please try again.')'`);
e.code = 'MODULE_UNPARSEABLE';
throw e;}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__44f1a614._.js.map